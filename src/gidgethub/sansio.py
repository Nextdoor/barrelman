...
class RateLimit:
    ...
    def from_http(cls, headers: Mapping) -> "RateLimit":
        ...
        limit = int(headers.get("x-ratelimit-limit")) if "x-ratelimit-limit" in headers else None
        remaining = int(headers.get("x-ratelimit-remaining")) if "x-ratelimit-remaining" in headers else None
        reset_epoch = float(headers.get("x-ratelimit-reset")) if "x-ratelimit-reset" in headers else None
    ...
    if status_code in {200, 201, 204}:
        ...
        if status_code >= 500:
            ...
            if status_code == 403:
                ...
                print("File not found or you do not have permission to access this repo")
